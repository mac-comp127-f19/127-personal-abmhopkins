...
public class LibraryMain {
    ...
    public static void main(String[] args) {
        ...
        library.add(new Video("Knives Out", "Rian Johnson", 5));
        library.add(new Video("Parasite", "Joon-ho Bong", 2));
        library.add(new Video("Get Out", "Jordan Peele", 3));
        library.add(new Video("Chef", "Jon Favreau", 4));
        // If you create additional Media classes, add those items too!
        library.add(new RareManuscripts("Othello","William Shakespeare"));
