...
public class InkBlot {
    ...
    public void generateInkBlot() {
        RandomWalk walkX = new RandomWalk(150, 0, 300);
        RandomWalk walkY = new RandomWalk(150, 0, 300);
        RandomWalk walkRed = new RandomWalk(150, 0, 255);
        RandomWalk walkGreen = new RandomWalk(150, 0, 255);
        RandomWalk walkBlue = new RandomWalk(150,0, 255);
        for (int steps = 0 ; steps < STEPS ; steps ++){
            Line firstLine = advance(walkX,walkY);
            firstLine.setStrokeColor(getColor(walkRed,walkGreen,walkBlue));
            Line secondLine = mirror(firstLine);
            canvas.add(firstLine);
            canvas.add(secondLine);
        }
    }
